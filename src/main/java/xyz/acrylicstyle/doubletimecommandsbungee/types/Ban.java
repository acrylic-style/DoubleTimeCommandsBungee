...
public class Ban {
    ...
    public Ban(int id, UUID player, String reason, long bannedAt, long expires, UUID executor, String unbanner) {
        this.id = id;
        this.player = player;
        this.reason = reason;
    ...
    public final long getBannedAt() { return this.bannedAt; }
